...
<body>
<span class="text-primary me-1">TenDangNhap: ${customer.tenDangNhap}  </span>
</hr>
<span class="text-primary me-1"> sđt: ${customer.soDienThoai}</span>
                        ...
                        <div class="col-xl-3 col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                            <div class="product-item">
                                ...
                                <div class="text-center p-4">
                                    ...
                                    <span class="text-body text-decoration-line-through">100.000đ</span>
                                </div>
