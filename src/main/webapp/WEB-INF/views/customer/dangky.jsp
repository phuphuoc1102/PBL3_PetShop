						...
						<div class="row g-3">
							<div class="col-12">
								<form:input type="text"
									...
									placeholder="Tên đăng nhập" style="height: 55px;" />
							</div>
							<div class="col-12">
								<form:input type="password"
									class="form-control bg-light border-0 px-4" path="matKhau"
									placeholder="Mật khẩu" style="height: 55px;" />
							</div>

							<div class="col-12">
								<input type="password"
									class="form-control bg-light border-0 px-4"
									placeholder="Nhập lại mật khẩu" style="height: 55px;" />
							</div>
							<div class="col-12">
								<form:input type="tel"
									class="form-control bg-light border-0 px-4"
							...
							<hr />
							<!-- 	<div class="col-12">
								<label for="dongYDieuKhoan" class="form-label">Đồng ý
									với <a>điều khoản của công ty </a>
